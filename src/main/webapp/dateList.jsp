...
<body class="container">
	...
	<table class="table table-hover">
		...
		<%
			for(Cash c : list) {
		%>
				<tr onclick="location.href='/cashbook-mvc/cash/cashOne.jsp?cashNo=<%=c.getCashNo()%>'" style="cursor:pointer;">
					<td><%=c.getKind()%></td>
					<td><%=c.getTitle()%></td>
	...
	<div>
		<a class="btn btn-outline-primary" href="/cashbook-mvc/monthList.jsp?targetYear=<%=y%>&targetMonth=<%=m - 1%>">달력</a>
		<a class="btn btn-outline-primary" href="/cashbook-mvc/cash/insertCashForm.jsp">새 내역 등록</a>
	</div>
</body>
</html>