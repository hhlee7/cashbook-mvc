...
<%
	...
	if(title.equals("")) {
		...
		response.sendRedirect("/cashbook-mvc/category/updateCategoryForm.jsp?categoryNo=" + categoryNo + "&msg=" + msg);
		return;
	}
	...
	if(result == 0) {
		...
		response.sendRedirect("/cashbook-mvc/category/categoryList.jsp");
